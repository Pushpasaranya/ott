...
class AuthService {
  ...
  Future<UserCredential?> loginWithGoogle()async{
    ...
    try{
      final googleUser = await GoogleSignIn(clientId: "479314531390-5j4400ov4uigkr9ulbpp8m47j1vrr1bk.apps.googleusercontent.com" ).signIn();
...
exceptionHandler(String code){
  switch(code){
    ...
    case"phonenumber is not valid":
      log("Your phonenumber must contain 10 letter");
